            ...
            <div className="sm:px-6 lg:px-0">
              <div className="relative isolate overflow-hidden bg-orange-500 px-6 pt-8 sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pt-16 sm:pl-16 sm:pr-0 lg:mx-0 lg:max-w-none">
                ...
                <div className="mx-auto max-w-2xl sm:mx-0 sm:max-w-none">
                  <Image src="/images/viewFunction.png" alt="Product screenshot" width="2432" height="1442" className="-mb-12 w-[57rem] max-w-none rounded-tl-xl bg-gray-800 ring-1 ring-white/10" />
                </div>
