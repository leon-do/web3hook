          ...
          <div className="mt-12 space-y-4 sm:mt-16 sm:grid sm:grid-cols-2 sm:gap-6 sm:space-y-0 lg:mx-auto lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-2">
            <div className="divide-y divide-gray-200 rounded-lg border border-gray-200 shadow-sm">
              <div className="p-6">
                ...
                <button onClick={() => signIn(undefined, { callbackUrl: "/checkout" })} className="mt-8 block w-60 rounded-md border border-orange-300 bg-orange-300 py-2 text-center text-xl  text-white hover:bg-orange-300">
                  Sign Up
                </button>
              </div>
              <div className="px-6 pt-6 pb-8">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li className="flex space-x-3">
                    ...
                    <span className="text-l text-gray-500">Send Transactions</span>
                  </li>
                  ...
                  <li className="flex space-x-3">
                    ...
                    <span className="text-l text-gray-500">Write Functions</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="divide-y divide-gray-200 rounded-lg border border-gray-200 shadow-sm">
              <div className="p-6">
                ...
                <p className="mt-4 text-l text-gray-500">Unlimited Usage</p>
                <p className="mt-8">
                  <span className="text-4xl font-bold tracking-tight text-gray-900">$50</span>
                  <span className="text-base font-medium text-gray-500">/mo</span>
                </p>
                <button onClick={() => signIn(undefined, { callbackUrl: "/checkout?payment_method_collection=always" })} className="mt-8 block w-60 rounded-md border border-orange-600 bg-orange-600 py-2 text-center text-xl  text-white hover:bg-orange-700">
                  Sign Up
                </button>
              </div>
              <div className="px-6 pt-6 pb-8">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li className="flex space-x-3">
                    ...
                    <span className="text-l text-gray-500">Pay as you go credits</span>
                  </li>
                  ...
                  <li className="flex space-x-3">
                    ...
                    <span className="text-l text-gray-500">One on one support</span>
                  </li>
                </ul>
              </div>
            </div>
