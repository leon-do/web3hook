          ...
          <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <button onClick={() => signIn(undefined, { callbackUrl: "/checkout" })} className="w-60 text-center text-xl items-center rounded-md border border-transparent bg-orange-600 px-6 py-3 text-white shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                  Sign Up
                </button>
              </div>
            </div>
